...
- [Exploit Database - searchable archive of exploits](https://www.exploit-db.com/)
- [VulnHub - Vulnerable machines for practice](https://www.vulnhub.com/)
...
- Create accounts in tryhackme.com ,academy.hackthebox.com and portswigger.com
	*If you are comfortable with Tryhackme content.just continue that learning paths*
...
there are some rooms that only for premium subscribers .just google search the lesson's title name and you can find some write ups of that. that's how I do those for free.
	If you can spend some bucks to tryhackme .It is absolutely worth for money.(by the way , I am not affiliated with any of those organizations .I learn by them ,I'm just suggesting for you)
...
- [CyberChef - Swiss Army knife for cyber operations](https://gchq.github.io/CyberChef/)
...
- Web Application Basics
	...
	- RESTful APIs
- [DBMS Basics](https://www.w3schools.com/sql/default.asp) (Database Management System) - { Optional }
	 *learn something like mySQL ,this will helpful when we learn about Database Injections Like SQL injection*
...
- [Hacking Web Applications - TCM Security (new)](https://youtu.be/1GJ_LwNw6sc?feature=shared)
- [Hacking Web Applications - TCM Security Full Course](https://youtu.be/24fHLWXGS-M?feature=shared)
...
- You don't need to pay for the premium course. just use these free YouTube tutorials.
	- [TCM Security Ethical Hacking in 15 hours part 1](https://youtu.be/3FNYvj2U0HM?feature=shared)
	- [TCM Security Ethical Hacking in 15 hours part 2](https://youtu.be/sH4JCwjybGs?feature=shared)
...
- Hackthebox [Starting point Boxes](https://app.hackthebox.com/starting-point) -> {*Do the Free boxes with [CryptoCat Videos](https://www.youtube.com/watch?v=jQ194vU4Qkk&list=PLHUKi1UlEgOINz5PLYb9yu7evQZ_5MQ21)*}
- Tryhackme - [PickleRick](https://tryhackme.com/room/picklerick) -> {[use john hammond video for this](https://youtu.be/oCAtfcr3iUw?feature=shared)}
- [Basic Penetration Testing](https://tryhackme.com/room/basicpentestingjt)-> {[john hammond video](https://youtu.be/xl2Xx5YOKcI?feature=shared)}
- [Vulnversity](https://tryhackme.com/jr/vulnversity) -> {[john hammond video](https://youtu.be/rrpy_bcMvjo?feature=shared)}
...
- [Linux Privilege Escalation](https://youtu.be/ZTnwg3qCdVM?feature=shared) 
	*use this resources as well*
	- https://tryhackme.com/jr/introtoshells
	- https://tryhackme.com/jr/linuxprivesc
	- [GTFOBins for Linux privilege escalation techniques](https://gtfobins.github.io/)
-  Active Directory Hacking: 
	...
	- [Active Directory - TCM Security](https://youtu.be/VXxH4n684HE?feature=shared)
	- [Attacking Active Directory - TryHackMe](https://tryhackme.com/room/attackingad)
- [Windows Privilege Escalation](https://youtu.be/uTcrbNBcoxQ?feature=shared)
...
- ##### Web Hacking 201 - Follow the [portwigger](https://portswigger.net/web-security/learning-paths) Learning Path
...
- Cryptography Basics
	- [Hashing - Cryptography basics](https://tryhackme.com/jr/hashingcrypto101)
	- [John The Ripper](https://tryhackme.com/jr/johntheripper0)
	- Public Key Infrastructure
	- Encryption vs Encoding vs Hashing
- [OSINT](https://youtu.be/qwA6MmbeGNo?feature=shared)
	*OSINT is a Recon skill. Try this Google dork to find some challenges.*
  ```
...
##### but How ??
- watch hackers podcasts and interviews ,that's how I made my own one.
*I recommend you to watch these all Videos*
	- [john hammond and networkchuck Interview](https://www.youtube.com/live/wIn3L24lksI?feature=shared)
	- [john hammond and networkchuck Interview 2](https://www.youtube.com/live/5dxuppvclxE?feature=shared)
	- [Rana khalil Interview With David Bombal ](https://youtu.be/Zfz3ZN2dTDM?feature=shared)
	- [TCM security Roadmaps](https://youtu.be/u4VWQZ8KLmI?feature=shared)
	- https://youtu.be/4JZjj_H4ei4?feature=shared
	- [Nahamsec Interview With Networkchuck](https://www.youtube.com/live/sp-hvw5rhy8?feature=shared)
