...
- If you stuck in some point.Try these steps :
	...
	- Search in youtube.
	most of the time a good google search can always give you the answer.Searching is a part of this game.
...
### Play CTF's to practice Skills side by side
...
- So Learn by Them.
I suggest you to try these. you don't need to get the flags. just try and have fun.To play these boxes ,you need accounts in :
- app.hackthebox.com
- tryhackme.com
...
- Tryhackme - [PickleRick](https://tryhackme.com/room/basicpentestingjt) -> {[use john hammond video for this](https://youtu.be/oCAtfcr3iUw?feature=shared)}
...
- [Vulnversity](https://tryhackme.com/jr/vulnversity) -> {[john hammond video]()}
